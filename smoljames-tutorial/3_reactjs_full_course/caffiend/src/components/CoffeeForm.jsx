...
export default function CoffeeForm(props){
    ...
    async function handleSubmitForm() {
        ...
        // define a guard clause that only submists the form if it is completed 
        if (!selectedCoffee) {
            return
        }
    ...
    return (
        <>
            ...
            {showCoffeeTypes && (
                ...
                }} id="coffee-list" className="coffee-list">
            ...
            <h4>Add the cost ($)</h4>
            <input className="w-full" type="number" value={coffeeCost} onChange={
                (e) => {
