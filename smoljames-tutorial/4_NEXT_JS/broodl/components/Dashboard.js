      ...
      <div className='flex items-stretch flex-wrap gap-4'>
        {Object.keys(moods).map((mood, moodIndex) => {
          return (
            ...
            }} className={'cursor-pointer p-4 px-5 rounded-2xl purpleShadow \
              duration-200 bg-indigo-50 hover:bg-indigo-100 text-center \
              flex flex-col gap-4 flex-1 '} key={moodIndex}>
